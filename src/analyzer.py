...
class LearningAnalyzer:
    ...
    def get_basic_stats(self) -> Dict:
        ...
        stats = {
            ...
            'avg_activities_per_student': len(self.df) / self.df['student_id'].nunique()
        }
    ...
    def analyze_student_performance(self) -> Dict:
        ...
        return {
            ...
            'performance_distribution': student_scores['performance_level'].value_counts().to_dict(),
            'correlation_activity_score': float(student_scores['activity_count'].corr(student_scores['score']))
        }
    ...
    def analyze_activity_effectiveness(self) -> Dict:
        ...
        activity_scores['effectiveness_rank'] = activity_scores['avg_score'].rank(ascending=False)
